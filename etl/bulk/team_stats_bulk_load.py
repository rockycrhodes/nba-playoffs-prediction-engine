...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  6 16:03:41 2026
    ...
    for _, row in df.iterrows():
        cur.execute('''
            INSERT INTO team_game_stats (
                ...
                turnovers, pf, pts, plus_minus, season, season_type  -- <--- ADD THIS
...
if __name__ == '__main__':
    df_clean = pd.read_csv('team_stats_for_load_bulk.csv')
